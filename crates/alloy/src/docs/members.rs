...
pub const MEMBERS: &[(&str, &[Member])] = &[
    (
        ...
        &[
            Member {
                ...
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal prices: HashMap<string, number> = HashMap.new()\nprices:set(\"sword\", 10)",
            },
            Member {
                name: "from",
                kind: MemberKind::Static,
                ...
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal prices = HashMap.from({ sword = 10, pet = 25 })\nprint(prices:len())",
            },
            Member {
                name: "get",
                ...
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal prices = HashMap.from({ sword = 10 })\nlocal price = prices:get(\"sword\") ?? 0\nprint(price)",
            },
            Member {
                name: "set",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal prices = HashMap.from({ gem = 5 })\nif prices:has(\"gem\") then\n    print(\"in stock\")\nend",
            },
            Member {
                name: "remove",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal prices = HashMap.from({ gem = 5, sword = 10 })\nprint(prices:len())",
            },
            Member {
                name: "keys",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal counts: HashMap<string, number> = HashMap.new()\nlocal n = counts:get_or_insert(\"hits\", 0)\nprint(n)",
            },
            Member {
                name: "clear",
                kind: MemberKind::Method,
            ...
            Member {
                name: "to_table",
                kind: MemberKind::Method,
                signature: "HashMap:to_table(): { [K]: V }",
                doc: "The map's own table, not a copy: a write through it changes the map. Such a write skips the count, so use `set` when `len` must stay true.",
                example: "import { HashMap } from \"@alloy/std/collections\"\n\nlocal prices = HashMap.from({ gem = 5 })\nlocal t = prices:to_table()\nprint(t.gem)",
            },
        ],
    ),
    (
        ...
        &[
            Member {
                ...
                example: "import { Set } from \"@alloy/std/collections\"\n\nlocal seen: Set<string> = Set.new()\nseen:add(\"a\")",
            },
            Member {
                name: "from",
                kind: MemberKind::Static,
            ...
            Member {
                name: "to_table",
                kind: MemberKind::Method,
                signature: "Set:to_table(): { [T]: boolean }",
                doc: "The set's own table, not a copy: each member is a key with the value true. A write through it changes the set and skips the count, so use `add` when `len` must stay true.",
                example: "local seen = $set[1, 2]\nlocal t = seen:to_table()\nprint(t[1])",
            },
        ],
    ),
    (
        ...
        &[
            Member {
                name: "new",
                kind: MemberKind::Static,
                signature: "BitSet.new(size: number?): BitSet",
                doc: "An empty set with room for the numbers below `size`, or below 256 without it. A larger number grows the buffer, so `size` only saves the copies.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal visited = BitSet.new(1024)\nvisited:add(7)",
            },
            Member {
                name: "from",
                kind: MemberKind::Static,
                signature: "BitSet.from(indices: { number }): BitSet",
                doc: "A new set of the numbers in an array. A repeated number joins once.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.from({ 1, 2, 2, 9 })\nprint(bits:len())",
            },
            Member {
                name: "add",
                kind: MemberKind::Method,
                signature: "BitSet:add(index: number): BitSet",
                doc: "Adds `index` and returns the set, so calls chain. The number must be whole and 0 or more, or the call raises.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.new()\nbits:add(3):add(5)\nprint(bits:has(5))",
            },
            Member {
                name: "has",
                kind: MemberKind::Method,
                signature: "BitSet:has(index: number): boolean",
                doc: "Whether `index` is a member. A number below 0, past the buffer, or with a fraction is not one.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.from({ 4 })\nprint(bits:has(4))",
            },
            Member {
                name: "remove",
                kind: MemberKind::Method,
                signature: "BitSet:remove(index: number): boolean",
                doc: "Removes `index` and says whether it was there.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.from({ 4 })\nprint(bits:remove(4))",
            },
            Member {
                name: "len",
                kind: MemberKind::Method,
                signature: "BitSet:len(): number",
                doc: "The number of members. The set counts as members come and go, so this costs the same at any size.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.from({ 1, 2, 3 })\nprint(bits:len())",
            },
            Member {
                name: "is_empty",
                kind: MemberKind::Method,
                signature: "BitSet:is_empty(): boolean",
                doc: "Whether the set holds no members.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.new()\nprint(bits:is_empty())",
            },
            Member {
                name: "clear",
                kind: MemberKind::Method,
                signature: "BitSet:clear()",
                doc: "Removes every member. The buffer keeps its size.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.from({ 1, 2 })\nbits:clear()",
            },
            Member {
                name: "union",
                kind: MemberKind::Method,
                signature: "BitSet:union(other: BitSet): BitSet",
                doc: "A new set of the members of both, built 32 bits at a time. Neither input changes.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal a = BitSet.from({ 1, 2 })\nlocal b = BitSet.from({ 2, 3 })\nprint(a:union(b):len())",
            },
            Member {
                name: "intersection",
                kind: MemberKind::Method,
                signature: "BitSet:intersection(other: BitSet): BitSet",
                doc: "A new set of the members that both hold.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal a = BitSet.from({ 1, 2 })\nlocal b = BitSet.from({ 2, 3 })\nprint(a:intersection(b):len())",
            },
            Member {
                name: "difference",
                kind: MemberKind::Method,
                signature: "BitSet:difference(other: BitSet): BitSet",
                doc: "A new set of this set's members that `other` does not hold.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal a = BitSet.from({ 1, 2 })\nlocal b = BitSet.from({ 2, 3 })\nprint(a:difference(b):len())",
            },
            Member {
                name: "to_array",
                kind: MemberKind::Method,
                signature: "BitSet:to_array(): number[]",
                doc: "The members as an array, in rising order.",
                example: "import { BitSet } from \"@alloy/std/collections\"\n\nlocal bits = BitSet.from({ 9, 2 })\nprint(bits:to_array():join(\", \"))",
            },
        ],
    ),
    (
        ...
        &[
            ...
            Member {
                name: "remove",
                kind: MemberKind::Method,
                signature: "Array:remove(index: number): T?",
                doc: "Removes the item at `index` and returns it. The items after it move down one, so the order stays and the cost grows with the length. `swap_remove` costs the same at any length.",
                example: "local xs = [ 1, 2, 3 ]\nprint(xs:remove(1))\nprint(xs:join(\", \"))",
            },
            Member {
                name: "swap_remove",
                kind: MemberKind::Method,
                signature: "Array:swap_remove(index: number): T?",
                doc: "Removes the item at `index` and returns it. The last item moves into its place, so the call costs the same at any length and the order changes. An index outside the array removes nothing and returns nil.",
                example: "local xs = [ 1, 2, 3 ]\nprint(xs:swap_remove(1))\nprint(xs:join(\", \"))",
            },
            Member {
                name: "first",
                kind: MemberKind::Method,
            ...
            Member {
                name: "to_table",
                kind: MemberKind::Method,
                signature: "Array:to_table(): { T }",
                doc: "The array's own table, not a copy: a write through it changes the array. An array is its own table, so the result is the same value under the plain table type.",
                example: "local xs: number[] = [ 1, 2 ]\nlocal t: { number } = xs:to_table()\nprint(#t)",
            },
        ],
    ),
    (
    ...
    (
        ...
        &[
            Member {
                ...
                example: "import { Queue } from \"@alloy/std/collections\"\n\nlocal jobs: Queue<string> = Queue.new()\njobs:push(\"build\")",
            },
            Member {
                name: "from",
                kind: MemberKind::Static,
                ...
                example: "import { Queue } from \"@alloy/std/collections\"\n\nlocal jobs = Queue.from({ \"build\", \"test\" })\nprint(jobs:pop())",
            },
            Member {
                name: "push",
                kind: MemberKind::Method,
            ...
            Member {
                name: "to_table",
                kind: MemberKind::Method,
                signature: "Queue:to_table(): { T }",
                doc: "The queue's own table, not a copy: a write through it changes the queue. The keys start at the front, which a pop moves up, so read `to_array` for a list that starts at 1.",
                example: "import { Queue } from \"@alloy/std/collections\"\n\nlocal jobs = Queue.from({ \"build\", \"test\" })\nlocal t = jobs:to_table()\nprint(t[1])",
            },
        ],
    ),
    (
        ...
        &[
            Member {
                ...
                example: "import { Heap } from \"@alloy/std/collections\"\n\nlocal open = Heap.new(function(a: number, b: number) return a < b end)\nopen:push(3)",
            },
            Member {
                name: "from",
                kind: MemberKind::Static,
            ...
            Member {
                ...
                example: "import { Heap } from \"@alloy/std/collections\"\n\nlocal costs: Heap<number> = Heap.new()\ncosts:push(3)",
            },
            Member {
                name: "pop",
                kind: MemberKind::Method,
            ...
            Member {
                name: "to_table",
                kind: MemberKind::Method,
                signature: "Heap:to_table(): { T }",
                doc: "The heap's own table, not a copy: a write through it changes the heap. The order is heap order, not sorted order, and a write breaks what `pop` needs; `to_array` sorts a copy.",
                example: "import { Heap } from \"@alloy/std/collections\"\n\nlocal costs = Heap.from({ 3, 1, 2 })\nlocal t = costs:to_table()\nprint(#t)",
            },
        ],
    ),
    (
        ...
        &[
            Member {
                ...
                example: "import { Scope } from \"@alloy/std/async\"\n\nlocal scope = Scope.new()\nprint(scope:len())",
            },
            Member {
                name: "add",
                kind: MemberKind::Method,
    ...
    (
        ...
        &[
            Member {
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal xs = Iter.from([ 1, 2, 3 ]):collect()\nprint(xs:len())",
            },
            Member {
                name: "range",
                kind: MemberKind::Static,
            ...
            Member {
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal it = Iter.from([ 1, 2 ])\nprint(it:next())",
            },
            Member {
                name: "map",
                kind: MemberKind::Method,
                signature: "Iter:map<U>(f: (T) -> U): Iter<U>",
                doc: "Each value as `f(value)`, still lazily. The result keeps the new element type, however long the chain.",
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal names = Iter.from([ 1, 2 ]):map(function(n) return `#{n}` end)\nprint(names:collect():join(\", \"))",
            },
            Member {
                name: "filter",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal big = Iter.from([ 1, 5 ]):filter(function(n) return n > 2 end)\nprint(big:count())",
            },
            Member {
                name: "take",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nprint(Iter.range(1, 100):take(3):count())",
            },
            Member {
                name: "skip",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nprint(Iter.range(1, 5):skip(3):count())",
            },
            Member {
                name: "take_while",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal it = Iter.range(1, 10):take_while(function(n) return n < 4 end)\nprint(it:count())",
            },
            Member {
                name: "chain",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal both = Iter.from([ 1 ]):chain(Iter.from([ 2 ]))\nprint(both:count())",
            },
            Member {
                name: "collect",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal xs = Iter.range(1, 3):collect()\nprint(xs:join(\", \"))",
            },
            Member {
                name: "to_table",
                kind: MemberKind::Method,
                signature: "Iter:to_table(): { T }",
                doc: "The rest of the run, drained into a new table. An Iter holds no table of its own, so this one is a copy, and the pull spends the iterator: a second call gives an empty table.",
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal t = Iter.range(1, 3):to_table()\nprint(#t)",
            },
            Member {
                name: "for_each",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nIter.from([ 1, 2 ]):for_each(function(n) print(n) end)",
            },
            Member {
                name: "count",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nprint(Iter.from([ 1, 5 ]):any(function(n) return n > 3 end))",
            },
            Member {
                name: "all",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nprint(Iter.from([ 1, 5 ]):all(function(n) return n > 0 end))",
            },
            Member {
                name: "find",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nprint(Iter.range(1, 10):find(function(n) return n % 4 == 0 end))",
            },
            Member {
                name: "reduce",
                kind: MemberKind::Method,
                ...
                example: "import { Iter } from \"@alloy/std/iter\"\n\nlocal sum = Iter.range(1, 4):reduce(function(acc: number, n) return acc + n end, 0)\nprint(sum)",
            },
            Member {
                name: "first",
                kind: MemberKind::Method,
    ...
    (
        ...
        &[Member {
            ...
            example: "import { Symbol } from \"@alloy/std/collections\"\n\nlocal key = Symbol.new(\"slot\")\nlocal t = { [key] = 1 }\nprint(t[key])",
        }],
    ),
    (
        "Signal",
        &[
            Member {
                ...
                example: "import { Signal } from \"@alloy/std/signal\"\n\nlocal damaged = Signal.new<<number>>()\ndamaged:Fire(10)",
            },
            Member {
                name: "is",
                kind: MemberKind::Static,
    ...
    (
        ...
        &[
            ...
            Member {
                ...
                example: "import { Serialize } from \"@alloy/std/serde\"\n\nfunction to_data<T: Serialize>(v: T): any\n    return v:serialize()\nend",
            },
        ],
    ),
];
