    ...
    (
        ...
        &[
            Member {
                ...
                example: "local visited = BitSet.new(1024)\nvisited:add(7)",
            },
            Member {
                name: "from",
                kind: MemberKind::Static,
                ...
                example: "local bits = BitSet.from({ 1, 2, 2, 9 })\nprint(bits:len())",
            },
            Member {
                name: "add",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "local bits = BitSet.from({ 4 })\nprint(bits:has(4))",
            },
            Member {
                name: "remove",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "local bits = BitSet.from({ 1, 2, 3 })\nprint(bits:len())",
            },
            Member {
                name: "is_empty",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "local bits = BitSet.from({ 1, 2 })\nbits:clear()",
            },
            Member {
                name: "union",
                kind: MemberKind::Method,
                ...
                example: "local a = BitSet.from({ 1, 2 })\nlocal b = BitSet.from({ 2, 3 })\nprint(a:union(b):len())",
            },
            Member {
                name: "intersection",
                kind: MemberKind::Method,
            ...
            Member {
                ...
                example: "local bits = BitSet.from({ 9, 2 })\nprint(bits:to_array():join(\", \"))",
            },
        ],
    ),
    (
    ...
    (
        ...
        &[
            ...
            Member {
                ...
                example: "local t = Iter.range(1, 3):to_table()\nprint(#t)",
            },
            Member {
                name: "for_each",
                kind: MemberKind::Method,
